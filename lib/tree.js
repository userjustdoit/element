...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/tree/src/tree.vue?vue&type=template&id=4c78056e&
var render = function () {
  var _vm = this
...
// CONCATENATED MODULE: ./packages/tree/src/tree.vue?vue&type=template&id=4c78056e&
...
;
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/tree/src/tree-node.vue?vue&type=template&id=6b44589e&
var tree_nodevue_type_template_id_6b44589e_render = function () {
  var this$1 = this
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    {
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.node.visible || _vm.isLoadMoreView,
          expression: "node.visible||isLoadMoreView",
        },
      ],
      ref: "node",
      ...
      class: {
        ...
        "is-select": _vm.node.data.select && !_vm.isLoadMoreView,
        "is-fold-area": _vm.node.level === _vm.tree.foldLevel + 1,
        "is-unselect": !_vm.node.data.select,
      },
      attrs: {
        role: "treeitem",
        tabindex: "-1",
    ...
    [
      !_vm.node.hideNode && !_vm.isLoadMoreView
        ? _c("node-content", {
            attrs: { node: _vm.node, slotName: "contentBefore" },
          })
        : _vm._e(),
      _c(
        "div",
        {
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: !_vm.node.hideNode,
              expression: "!node.hideNode",
            },
          ],
          ...
          style: {
            position: "relative",
            "padding-left":
              (_vm.node.level > _vm.tree.foldLevel
                ? _vm.node.level - _vm.tree.foldLevel - 1
                : _vm.node.level - 1) *
                _vm.tree.indent +
              "px",
          },
        ...
        [
          !_vm.node.hideNode
            ? _c("span", {
                ...
                style: _vm.isLoadMoreView ? { visibility: "hidden" } : {},
                on: {
                  click: function ($event) {
                    $event.stopPropagation()
            ...
            : _vm._e(),
          _vm.showCheckbox && !_vm.node.hideNode
            ? _c("el-checkbox", {
                style: _vm.isLoadMoreView ? { visibility: "hidden" } : {},
                attrs: {
          ...
          !_vm.node.hideNode
            ? _c("node-content", {
                style: _vm.isLoadMoreView ? { visibility: "hidden" } : {},
                attrs: { node: _vm.node, slotName: "contentLeft" },
              })
            : _vm._e(),
          _vm.isLoadMoreView
            ? _c(
                "el-button",
                {
                  attrs: {
                    type: "info",
                    size: "mini",
                    title: _vm.node.parent ? _vm.node.parent.label : "",
                  },
                  on: {
                    click: function ($event) {
                      _vm.$emit("loadMoreClick")
                    },
                  },
                },
                [_vm._v("加载更多")]
      ...
      !_vm.node.hideNode && !_vm.isLoadMoreView
        ? _c("node-content", {
            attrs: { node: _vm.node, slotName: "contentAfter" },
          })
        : _vm._e(),
      !_vm.node.hideNode && !_vm.isLoadMoreView
              ...
              ? _c(
                  ...
                  [
                    _vm._l(_vm.childNodes, function (child, index) {
                      return _c("el-tree-node", {
                        ...
                        attrs: {
                          ...
                          childAllCount: _vm.childNodes.length,
                          "render-after-expand": _vm.renderAfterExpand,
                          "show-checkbox": _vm.showCheckbox,
                          limitSize: _vm.limitSize,
                          node: child,
                    ...
                    _vm.showLoadMore
                      ? _c("el-tree-node", {
                          attrs: {
                            isLoadMoreView: _vm.showLoadMore,
                            limitSize: _vm.limitSize,
                            "show-checkbox": _vm.showCheckbox,
                            node: _vm.childNodes[_vm.childNodes.length - 1],
                          },
                          on: {
                            loadMoreClick: _vm.loadMoreClick,
...
var tree_nodevue_type_template_id_6b44589e_staticRenderFns = []
tree_nodevue_type_template_id_6b44589e_render._withStripped = true


// CONCATENATED MODULE: ./packages/tree/src/tree-node.vue?vue&type=template&id=6b44589e&
...
/* harmony default export */ var tree_nodevue_type_script_lang_js_ = ({
  ...
  components: {
    ...
    ElButton: button_default.a, /*NodeContent: {
                        props: {
                        node: {
                        required: true
                        }
    ...
    NodeContent: {
      ...
      render: function render(h) {
        ...
        var node = this.node;
        var isOther = this.slotName;
        var slotName = this.slotName ? this.slotName : 'default';
        var data = node.data,
            store = node.store;
  ...
  watch: {
    ...
    'limitSize': function limitSize(val) {
      this.refreshClick();
    }
  },
  ...
  methods: {
    ...
    //     }
    // },
    loadMoreClick: function loadMoreClick() {
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  tree_nodevue_type_template_id_6b44589e_render,
  tree_nodevue_type_template_id_6b44589e_staticRenderFns,
  false,
  null,
  null,
  null
